...
// Rounding decimals
console.log((2.7).toFixed(0)); // the outPut is string not a number
...
console.log(4556578900748754564293863478910174389n);
console.log(BigInt(455657890));

// Operation
console.log(10000n + 10000n);
// console.log(Math.sqrt(16n));

const huge = 202876485698697877451893n;
const num = 23;
...
console.log(new Date('Aug 15 2022 14:25:31'));
console.log(new Date('Aug 1 2023 00:18:58'));
